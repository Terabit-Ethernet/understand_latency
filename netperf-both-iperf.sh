...
taskset -c 4 iperf -c 192.168.10.146 -t 100 -p 6001 > $DIR/iperf-1 &
#taskset -c 8 iperf -c 192.168.10.146 -t 100 -p 6002 > $DIR/iperf-2 &
#taskset -c 12 iperf -c 192.168.10.146 -t 100 -p 6003 > $DIR/iperf-3 &
#taskset -c 16 iperf -c 192.168.10.146 -t 100 -p 6004 > $DIR/iperf-4 &
