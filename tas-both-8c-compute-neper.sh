...
# client-side
sudo /home/qizhe/tas/tas/tas --ip-addr=192.168.10.124/24 --fp-cores-max=1  --tcp-link-bw=100 --dpdk-extra="-w" --dpdk-extra="0000:25:00.0" --dpdk-extra="-l" --dpdk-extra="0,4" &
# server-side
#
ssh jaehyun\@128.84.155.146 -t 'sudo /home/qizhe/tas/tas/tas --ip-addr=192.168.10.125/24 --fp-cores-max=1  --tcp-link-bw=100 --dpdk-extra="-w" --dpdk-extra="0000:25:00.0" --dpdk-extra="-l" --dpdk-extra="0,4" &' &
...
# done
ssh jaehyun\@128.84.155.146 -t "sudo LD_PRELOAD=/home/qizhe/tas/lib/libtas_interpose.so taskset -c 8,12,16,20,24,28,32,36,40,44,48,52,56,60 /home/qizhe/neper/tcp_rr -F $N -T $thread -Q 64 -R 64 -l 60" > temp/eserver.log &
...
sudo LD_PRELOAD=/home/qizhe/tas/lib/libtas_interpose.so taskset -c 8,12,16,20,24,28,32,36,40,44,48,52,56,60 /home/qizhe/neper/tcp_rr -c -H 192.168.10.125 -F $N -T $thread -l 60  -A --percentiles=25,50,90,95,999 -Q 64 -R 64  > temp/client.log &
