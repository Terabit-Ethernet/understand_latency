...
# done
ssh jaehyun\@128.84.155.146 -t "sudo LD_PRELOAD=/home/qizhe/tas/lib/libtas_interpose.so taskset -c 8,12,16,20,24,28 /home/qizhe/tas/benchmarks/micro_rpc/echoserver_linux 1234 $thread foo 4096 64" > server.log &
...
sudo LD_PRELOAD=/home/qizhe/tas/lib/libtas_interpose.so taskset -c 8,12,16,20,24,28 /home/qizhe/tas/benchmarks/micro_rpc/testclient_linux 192.168.10.125 1234 $thread foo 64 1 $N > temp/client.log &
