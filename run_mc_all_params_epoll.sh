        ...
        do
            ...
            do
                ...
                do
                    ...
                    ./parse-netperf.py temp/linux_epoll_"$f"_"$k"_"$i"_"$l" $k > results/our_epoll_"$f"_"$k"_"$i"_"$j"_"$l"/arfs_latency &
    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    mkdir results/our_epoll_"$f"_"$k"_"$i"_"$j"_"$l"
                    ./parse-netperf.py temp/our_epoll_"$f"_"$k"_"$i"_"$j"_"$l" $k > results/our_epoll_"$f"_"$k"_"$i"_"$j"_"$l"/nrfs_latency &
