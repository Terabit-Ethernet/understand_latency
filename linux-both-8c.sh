...
for i in `seq 1 $N`; do
	sudo taskset -c $TASKSET netperf -H 192.168.10.125 -t TCP_RR -l 600 -j -p $DPORT -- -r $SIZE,$SIZE -b $IODEPTH,$IODEPTH -o throughput,mean_latency,p99_latency,p999_latency &> $DIR/netperf-$i-$N.log&
	PIDS="$PIDS $!"
